export const LoadUtils = () => {
    ...
    window.WWebJS.sendMessage = async (chat, content, options: any = {}) => {
        let attOptions: any = {};
    ...
    window.WWebJS.editMessage = async (msg, content, options: any = {}) => {
    ...
    window.WWebJS.cropAndResizeImage = async (media, options: any = {}) => {
