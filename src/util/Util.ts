...
export class Util {
     ...
     * @private
     */
    static mergeDefault(def: any, given: any): object {
        if (!given) return def;
     ...
     */
    static async formatImageToWebpSticker(media: MessageMedia, pupPage: Page): Promise<MessageMedia> {
     ...
     * @returns {Promise<MessageMedia>} media in webp format
     */
    static async formatToWebpSticker(media: MessageMedia, metadata: StickerMetadata, pupPage: Page): Promise<MessageMedia> {
